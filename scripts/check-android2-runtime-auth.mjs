...
has(workflow,"if: github.event_name == 'push' && github.ref == 'refs/heads/main'",'Privileged live auth provisioning must run only on trusted main pushes, never arbitrary pull requests.');

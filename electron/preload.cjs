...
contextBridge.exposeInMainWorld('desktopApi',{
  ...
  setProviderModel:(id,modelName)=>ipcRenderer.invoke('bridge:setProviderModel',{id,modelName}),
  setProviderEffort:(id,effort)=>ipcRenderer.invoke('bridge:setProviderEffort',{id,effort}),
